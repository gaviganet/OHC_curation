...
% 
 didefinition= 'A cellular electrophysiology assay where the membrane potential of a cell is controlled. by the experimentalist. This is accomplished through a feedback mechanism where any change in membrane potential is countered by permitting electrical current to flow into or out of the cell. ';
 dadefinition= char(didefinition);
 ATTRIBUTE      = 'definition';
...
% 
ATTRIBUTE      = 'definition';
description= ' DC electric potential applied to the cytoplasm of the cell where the potential outside the cell is defined as zero'; 
dadefinition= char(description);
...
ATTRIBUTE      = 'definition general';
description= 'A quality that is equal to the potential energy per unit charge associated with a static (time-invariant) electric field, also called the electrostatic potential'; 
dadefinition= char(description);
specific_string_attribute(DATASETID,ATTRIBUTE,dadefinition)
ATTRIBUTE      = 'imported from';
...
specific_string_attribute(DATASETID,ATTRIBUTE,dadefinition)
ATTRIBUTE      = 'definition general';
description= 'A physical quality which inheres in a bearer by virtue of the number of the bearers repetitive actions in a particular time';
dadefinition= char(description);
specific_string_attribute(DATASETID,ATTRIBUTE,dadefinition)
ATTRIBUTE      = 'imported from';
...
specific_string_attribute(DATASETID,ATTRIBUTE,dadefinition)
ATTRIBUTE      = 'definition general';
description= 'A physical quality that inheres in a bearer by virtue of the bearers amount of force per unit area it exerts.';
dadefinition= char(description);
specific_string_attribute(DATASETID,ATTRIBUTE,dadefinition)
ATTRIBUTE      = 'imported from';
...
name_def= char(didefinition);
DATASETID=create_and_write_string_dataset(group_id_4b,space,type,name_def,time_of_experiment);
% 
% attribute_general(DATASETID,researcher, dofexp, cellnumber, datasteward, datacurator,funder); % calls a function to add attributes
ATTRIBUTE      = 'definition';
...
name_def= char(didefinition);
DATASETID=create_and_write_double_dataset(group_id_4b,space,type,name_def,elapsed_time);
% 
% attribute_general(DATASETID,researcher, dofexp, cellnumber, datasteward, datacurator,funder); 
ATTRIBUTE      = 'definition';
