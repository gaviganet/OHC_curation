 function arm_devicev6(dirname, filename_fits,k_adult_male,count,pathfunctions,pathbegdata,pathsavedata)
...
DATASETID=create_and_write_string_dataset(group_id_ld,space,type,name_def,patch_clamp_amplifier);
...
space=H5S.create('H5S_SCALAR');
name_def='camera';
DATASETID=create_and_write_string_dataset(group_id_ld,space,type,name_def,camera);
...
space=H5S.create('H5S_SCALAR');
name_def='microscope';
DATASETID=create_and_write_string_dataset(group_id_ld,space,type,name_def,microscope);
...
DATASETID=create_and_write_string_dataset(group_id_ld,space,type,name_def,pressure_clamp);
