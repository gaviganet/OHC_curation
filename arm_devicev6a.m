...
ATTRIBUTE      = 'definition';
didefinition='Glass pipette fabricated with a micron sized opening (e.g., 1-3 micron) and a short taper (e.g., 1-3 mm) and usually made from borosilicate glass or quartz.';
dadefinition= char(didefinition);
specific_string_attribute(DATASETID,ATTRIBUTE,dadefinition);
ATTRIBUTE='note';
...
ATTRIBUTE='definition';
didefinition= 'A device which produces an image of an object';
dadefinition= char(didefinition);
write_attribute_for_group(group_id_lf,dadefinition,ATTRIBUTE);

ATTRIBUTE='label imported from';
didefinition= 'http://purl.obolibrary.org/obo/OBI_0000398';
dadefinition= char(didefinition);
write_attribute_for_group(group_id_lf,dadefinition,ATTRIBUTE);
% 
% % create datasets
