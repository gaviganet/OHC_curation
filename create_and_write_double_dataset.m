function [ datsetid ] = create_and_write_double_dataset(group_id_3a,space,type,name_def,weight)
...
H5D.write (datsetid, 'H5ML_DEFAULT', 'H5S_ALL', 'H5S_ALL', 'H5P_DEFAULT', weight);
