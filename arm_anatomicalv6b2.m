...
function arm_anatomicalv6b2(dirname, filename_fits,k_adult_male,count,pathfunctions,pathbegdata,pathsavedata)
...
didefinition= 'right cochlea, left cochlea,  unknown'; 
dadefinition= char(didefinition);
specific_string_attribute(DATASETID,ATTRIBUTE,dadefinition)
