...
% of the data design.  The first arm (arm_organismv6.m) opens and creates a
% specimen file and sets up the groups and datasets associated with the
% organism; the second arm (arm_devicev6.m) is associated with instruments
...
count =0;
%
arm_organismv6(dirname, filename_fits,k_adult_male,count,pathfunctions,pathbegdata,pathsavedata)
...
filename_fits='R1_prepubmale_mat2hdf5_out';
count =39;
arm_organismv6(dirname, filename_fits,k_prepub_male,count,pathfunctions,pathbegdata,pathsavedata);
...
filename_fits='R1_prepubfemale_mat2hdf5_out.mat';
count =60;
arm_organismv6(dirname, filename_fits,k_prepub_female,count,pathfunctions,pathbegdata,pathsavedata);
...
count =88;
arm_organismv6(dirname, filename_fits,k_adult_female,count,pathfunctions,pathbegdata,pathsavedata);
